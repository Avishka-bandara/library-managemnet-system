...
@vite(['resources/js/member/add-new-book.js', 'resources/assets/libs/toastr/toastr.js'])
@vite(['resources/assets/libs/toastr/toastr.css'])
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group-outline my-3">
                            ...
                            <input type="text" class="form-control" style="box-shadow: none " id="book_isbn"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="input-group-outline  my-3">
                            ...
                            <input type="text" class="form-control" style="box-shadow: none " id="book_author"
                    ...
                    <div class="col-md-6">
                        <div class=" input-group-outline my-3">
                            ...
                            <input type="text" class="form-control" style="box-shadow: none " id="book_publisher"
                                name="publisher">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class=" input-group-outline my-3">
                            ...
                            <input type="number" class="form-control" style="box-shadow: none " id="book_quantity"
