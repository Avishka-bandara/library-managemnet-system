            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    <div class=" input-group-outline my-3">
                        ...
                        <input type="text" class="form-control" style="box-shadow: none " name="name" id="name">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class=" input-group-outline my-3">
                        <label class="form-label">National Identity Number</label>
                        <input type="text" class="form-control" style="box-shadow: none" name="nic" id="nic"> 
                    </div>
                </div>
                {{-- <div class="col-md-5">
                    <div class=" input-group-outline my-3">
        ...
        <div class="row mt-4 py-3 ">
            <div class="col-lg-12 col-md-8 mb-md-0 ">
                    ...
                    <div class="table-responsive">
                        <table class="table align-items-center mb-0 datatables-ajax border" id="datatables-ajax">
                            <thead>
